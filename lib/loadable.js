...
function onLoadableLoad(loadable) {
    return __assign(__assign({}, loadable), { loading: true, success: false, errored: false, error: '' });
}
exports.onLoadableLoad = onLoadableLoad;
function onLoadableSuccess(loadable) {
    return __assign(__assign({}, loadable), { loading: false, success: true, errored: false, error: '' });
}
exports.onLoadableSuccess = onLoadableSuccess;
function onLoadableError(loadable, error) {
    return __assign(__assign({}, loadable), { loading: false, success: false, errored: true, error: error });
}
